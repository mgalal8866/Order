<div>
    <div class="product-box product-box-bg wow fadeIn">
            ...
            @auth('client')
                <ul class="product-option">
                    <li data-bs-toggle="tooltip" data-bs-placement="top" title="Wishlist">
                        <div wire:ignore> <a wire:click.prevent="addtowishlist({{ $product->id ?? '' }})" href=""
        ...
        <div class="product-detail">
            ...
            <h6 class="price theme-color">{{ $product->productd_Sele2 }}   جم   </h6> <del>   {{$product->productd_Sele1  }}  جم </del>
            @endif
