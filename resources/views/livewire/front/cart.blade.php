                                ...
                                <tbody>
                                    ...
                                    <tr class="product-box-contain">
                                        <td class="product-detail">
                                            <div class="product border-0">
                                                ...
                                                <div class="product-detail">
                                                    <ul>
                                                        <li class="name">
                                                            <a href="product-left-thumbnail.html">{{$c['productheader']['product_name']}}</a>
                                                        </li>


                                                        <li class="text-content"><span
                                                            class="text-title">{{__('tran.unit')}} : </span>{{$c['unit']['unit_name']}}</li>

                                                            <li class="text-content"><span class="text-title"> </span> </li>
                                                        <li>
                                                            <h5 class="text-content d-inline-block">{{__('tran.price')}} :</h5>
                                                            <span>{{$c['productd_Sele2']}}</span>
                                                            <span class="text-content">{{$c['productd_Sele1']}}</span>
                                                        </li>
                                                        <li>
                                                            <h5 class="saving theme-color">{{__('tran.yousave')}}  : {{ $c['productd_Sele1']- $c['productd_Sele2']}}</h5>
                                                        </li>
                                        ...
                                        <td class="price">
                                            ...
                                            <h5> {{$c['productd_Sele2']}}<del class="text-content">{{$c['productd_Sele1']}}</del></h5>
                                            <h6 class="theme-color">{{__('tran.yousave')}} : {{ $c['productd_Sele1']- $c['productd_Sele2']}}</h6>
                                        </td>
                                            ...
                                            <div class="quantity-price">
                                                <div class="cart_qty">
                                                    <div class="input-group">
                                                        ...
                                                        <button type="button" class="btn " wire:click.prevent="minus('{{$index}}')">
                                                            <i class="fa fa-minus ms-0" aria-hidden="true"></i>
                                                        </button>
                                                        <input class="form-control input-number qty-input" type="text"
                                                            name="quantity" wire:model="cartlist.{{$index}}.cart.0.qty">
                                                        <button type="button" class="btn "
                                                        wire:click.prevent="pluse('{{$index}}')" data-field="">
                                        ...
                                        <td class="save-remove">
                                            ...
                                            <a class="remove close_button"  wire:click.prevent="removefromcart('{{$index}}')">{{__('tran.removecart')}}</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
